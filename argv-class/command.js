...
switch (command) {
    case 'add':
        Note.addNote(argv.id, argv.title, argv.body);
        break;
    case 'all':
        console.log(Note.getAll());
        break;
    case 'get':
        console.log(Note.getNote(argv.id, argv.title));
        break;
    case 'remove':
        console.log(Note.removeNote(argv.id, argv.title));
        break;
    case 'edit':
        console.log(Note.editNote(argv.id, argv.oldtitle, argv.title, argv.body));
        break;
    default:
